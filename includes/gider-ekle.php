<head>
    <title>Gider Ekle | <?=$sitebaslik?></title>
</head>
<?php
    ...
    <div class="side-app">
        ...
        <div class="main-container container-fluid">
            ...
            <div class="page-header">
                <h1 class="page-title">Gider Ekle</h1>
                <div>
                    <ol class="breadcrumb">
                ...
                <?php
                    if($_POST)
                    {
                        if(!empty($_POST["kategori"]) && !empty($_POST["baslik"]) && !empty($_POST["miktar"]))
                        {
                            ...
                            if(!empty($_FILES["resim"]["name"])) {
                                ...
                                if ($uzanti == "doc" || $uzanti == "docx" || $uzanti == "pdf" || $uzanti == "xlsx" || $uzanti == "xls" || $uzanti == "ppt" || $uzanti == "xml" || $uzanti == "mp4" || $uzanti == "avi" || $uzanti == "mov") {
                                    ...
                                    if($yukle!=false)
                                    {
                                        ...
                                        $ekle=$DB->RunQuery("INSERT INTO ".$tablo."","SET gider_numarasi=?, gider=?, kategori=?, ekleyen_uye=?, gider_adi=?, ek_dosya=?, tarih=?",array($gelirkod,$miktar,$kategori,$kullanici_id,$baslik,$yukle,date("Y-m-d")));
                            ...
                            {
                                        ?>
                                        <div class="alert alert-success"><i class="fa fa-check-circle"></i> Gider başarıyla eklendi.</div>
                                ...
                                <?php
                                    ...
                                    $ekle=$DB->RunQuery("INSERT INTO ".$tablo."","SET gider_numarasi=?, gider=?, kategori=?, ekleyen_uye=?, gider_adi=?, tarih=?",array($gelirkod,$miktar,$kategori,$kullanici_id,$baslik,date("Y-m-d")));
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control select2" style="width: 100%;" name="kategori">
                                            <?php
					$sonuc=$DB->callCategory("giderler","",-1);
					if($sonuc!=false)
					{
					...
					?>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="baslik" placeholder="Gider İsmini Giriniz">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                        ...
                                        <div class="col-md-3">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Gider Miktarını Giriniz" name="miktar" onkeypress="return event.charCode >= 48 && event.charCode <= 57">
                                            </div>
                                        </div>
                            ...
                            <div class="card-footer">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <button type="submit" name="ekle" class="btn btn-success">Gider Ekle</button>
                                    </div>
                                </div>
                                <!--End Row-->
                            </div>
