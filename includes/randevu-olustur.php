<head>
    <title>Randevu Oluştur | <?=$sitebaslik?></title>
</head>
<?php
    ...
    <div class="side-app">
        ...
        <div class="main-container container-fluid">
            ...
            <div class="page-header">
                <h1 class="page-title">Randevu Oluştur</h1>
                <div>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Randevular</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Randevu Oluştur</li>
                    </ol>
                </div>
            </div>
            <!-- PAGE-HEADER END -->
            ...
            <div class="row">
                ...
                <?php
                    if($_POST)
                    {
                        if(!empty($_POST["kategori"]) && !empty($_POST["baslik"]) && !empty($_POST["gorusme_tarihi"]) && !empty($_POST["randevu_tarihi"]) && !empty($_POST["musteri_adsoyad"]) && !empty($_POST["musteri_telefon"]) && !empty($_POST["randevu_not"]))
                        {
                        ...
                        if($checkpackage!=false) {
                            ...
                            if(!empty($_FILES["resim"]["name"])) {
                                    ...
                                    if($yukle!=false)
                                    {
                                        ...
                                        $ekle=$DB->RunQuery("INSERT INTO randevular","SET kullanici_id=?, kategori=?, paketkodu=?, baslik=?, seflink=?, gorusme_tarihi=?, randevu_tarihi=?, randevu_saati=?, musteri_adsoyad=?, musteri_email=?, musteri_telefon=?, musteri_adress=?, randevu_not=?, resim=?, yaklasmadurum=?, durum=?, tarih=?",array($kullanici_id,$kategori,$paketkod,$baslik,$seflink,$gorusme_tarihi,$randevu_tarihi,$randevu_saati,$musteri_adsoyad,$musteri_email,$musteri_telefon,$musteri_adress,$randevu_not,$yukle,1,1,date("Y-m-d")));
                                    ...
                                    if($ekle!=false)
                            {
                                ...
                                <?php
                                    ...
                                    $ekle=$DB->RunQuery("INSERT INTO randevular","SET kullanici_id=?, kategori=?, paketkodu=?, baslik=?, seflink=?, gorusme_tarihi=?, randevu_tarihi=?, randevu_saati=?, musteri_adsoyad=?, musteri_email=?, musteri_telefon=?, musteri_adress=?, randevu_not=?, yaklasmadurum=?, durum=?, tarih=?",array($kullanici_id,$kategori,$paketkod,$baslik,$seflink,$gorusme_tarihi,$randevu_tarihi,$randevu_saati,$musteri_adsoyad,$musteri_email,$musteri_telefon,$musteri_adress,$randevu_not,1,1,date("Y-m-d")));
					...
					?>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-3">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="paketkod" placeholder="" aria-label="Paket Kodunu Giriniz" aria-describedby="paket-kodu">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="baslik" placeholder="Randevu Başlığı">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" id="gdate" placeholder="MM/DD/YYYY" type="date" data-date-format="d M Y" name="gorusme_tarihi" value="<?=date("Y-m-d")?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" id="rdate" placeholder="MM/DD/YYYY" type="date" data-date-format="d M Y" name="randevu_tarihi">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <label class="col-md-3 form-label">Randevu Saati :</label>
                                    <div class="col-md-9">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <!-- input-group-text -->
                                                    <input class="form-control" id="tpBasic" name="randevu_saati" placeholder="Saat Seç" type="text">
                                                </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" placeholder="Müşteri Ad Soyad" name="musteri_adsoyad">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-9">
                                        <input type="email" class="form-control" placeholder="Müşteri E-Posta Adresi" name="musteri_email">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" placeholder="Müşteri Telefon Numarası" name="musteri_telefon">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" placeholder="Müşteri Adres" name="musteri_adress">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9 mb-4">
                                        <textarea class="content" name="randevu_not"></textarea>
                                    </div>
                                </div>
                                <!--End Row-->
                            ...
                            <div class="card-footer">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <button type="submit" name="ekle" class="btn btn-success">Randevu Oluştur</button>
                                    </div>
                                </div>
                                <!--End Row-->
                            </div>
